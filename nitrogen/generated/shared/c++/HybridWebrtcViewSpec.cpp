...
namespace margelo::nitro::webrtc {
  ...
  void HybridWebrtcViewSpec::loadHybridMethods() {
    ...
    registerHybrids(this, [](Prototype& prototype) {
      ...
      prototype.registerHybridGetter("resizeMode", &HybridWebrtcViewSpec::getResizeMode);
      prototype.registerHybridSetter("resizeMode", &HybridWebrtcViewSpec::setResizeMode);
    });
  }
